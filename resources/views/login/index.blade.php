...
<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('loginA/logo.png') }}">
<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('loginA/logo.png') }}">
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('loginA/logo.png') }}">

<link rel="manifest" href="/">
<link rel="icon" type="image/x-icon" href="{{ asset('loginA/logo.png') }}">
...
<img src="{{ asset('loginA/l2.png') }}" loading="lazy" height="28" alt="" class="image-6">
