 ...
 <section id="hero" class="hero-section dark wf-section">
     ...
     <style>
        ...
        SALDO: R$<b class="saldo"> <?php echo isset($saldo) ? number_format($saldo, 2, ',', '.') : '0,00'; ?> </b>
            ...
            <p></p>
            <p>Escolha um valor para apostar:</p>
...
<p>Jogue com Dinheiro Real
</p>

<div class="">
<button onclick="window.location.href = '/deposito'"  class="primary-button w-button" style="background-color: #00FF00;">Depositar</button><br><br>
</div>
...
<div class="">
<button onclick="window.location.href = '/jogodemo'" value="Testar" class="primary-button w-button">Testar</button><br><br>
</div>
...
<div class="">
<button onclick="window.location.href = '/afiliate'" value="R$50 Grátis" class="primary-button w-button" style="background-color: #FF000D;">R$50 Grátis</button><br><br>
</div>
