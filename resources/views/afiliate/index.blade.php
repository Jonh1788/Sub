...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('afiliateFiles/logo.png')}}">
  <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('afiliateFiles/logo.png')}}">
  <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('afiliateFiles/logo.png')}}">


  <link rel="icon" type="image/x-icon" href="{{ asset('afiliateFiles/logo.png')}}">
    ...
    <div data-collapse="small" data-animation="default" data-duration="400" role="banner" class="navbar w-nav">
      <div class="container w-container">
        <a href="/painel" aria-current="page" class="brand w-nav-brand" aria-label="home">
          <img src="{{ asset('afiliateFiles/l2.png')}}" loading="lazy" height="28" alt="" class="image-6">
    ...
    <section id="hero" class="hero-section dark wf-section">
      ...
      <div class="padded">R$<?php echo floatval($saldo_cpa) + floatval($rev_ativo_sum); ?></div>
              ...
              <div class="grid-box">
                ...
                <a href="/painel" target="_blank" class="primary-button dark w-button">JOGAR AGORA</a>
              </div>
              <br>
