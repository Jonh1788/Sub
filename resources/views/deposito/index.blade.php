...
<img src="{{ asset('depositoFiles/l2.png')}}" loading="lazy" height="28" alt="" class="image-6">
...
<div class="button-container" style="margin: 0 auto;">
        <button type="button" class="button nav w-button" onclick="updateValue(20)">R$ 20<br>SEM BÔNUS</button>
        <button type="button" class="button nav w-button" onclick="updateValue(25)">R$ 25<br>R$75 BÔNUS</button>
        <br><br>
        <button type="button" class="button nav w-button" onclick="updateValue(30)">R$ 30<br>R$150 BÔNUS</button>
        <button type="button" class="button nav w-button" onclick="updateValue(50)">R$ 50<br>R$200 BÔNUS</button>
        <br><br>
    </div>
      ...
      <script>
        ...
        <input type="submit" id="submitButton" name="gerar_qr_code" value="Depositar via PIX" class="primary-button w-button" style="margin: 0 auto;">
    </form>
